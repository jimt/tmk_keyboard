...
/* keymap inspired by the TypeMatrix layout, with the backspace
 * and enter under the left and right thumbs
 */
 ...
 *  [     ]      (     )    &        ||       `     1     2     3    \
 * ctrl insert super shift esc  bspc ||   = space   fn    .     0    alt
 */
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP(KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, \
         ...
         KC_LCTL, KC_TAB, KC_LGUI, KC_LSFT, KC_ESC, KC_BSPC, KC_ENT,     \
   ...
   *  #   left   down  right  $        ||     pgdn    4     5     6    +
   *  [     ]      (     )    &        ||       `     1     2     3    \
   * ctrl insert super shift esc  L2   ||  = space   fn    .     0    alt
   */
  KEYMAP(SHIFT(KC_1), SHIFT(KC_2), KC_UP, SHIFT(KC_LBRC), SHIFT(KC_RBRC), \
                                ...
                                KC_LBRC, KC_RBRC, SHIFT(KC_9), SHIFT(KC_0), SHIFT(KC_7), \
                                  KC_GRAVE, KC_1, KC_2, KC_3, KC_BSLS,    \
                                KC_LCTL, SHIFT(KC_INS), KC_LGUI, KC_LSFT, KC_ESC, KC_FN1, \
                                  KC_EQUAL, KC_SPC, KC_FN0, KC_DOT, KC_0, KC_LALT),
   ...
   * ctrl  voldn  super shift esc  bspc || alt space   L0  prtsc scroll alt
   */
  KEYMAP(KC_INS, KC_HOME, KC_UP, KC_END, KC_PGUP, \
                         ...
                         KC_LCTL, KC__VOLDOWN, KC_LGUI, KC_LSFT, KC_ESC, KC_BSPC, \
                         KC_LALT, KC_SPC, KC_FN2, KC_PSCREEN, KC_SLCK, KC_LALT)
