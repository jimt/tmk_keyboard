...
/* keymap inspired by the TypeMatrix layout,
 * with the esc and enter under the left and right thumbs
 */
 ...
 *  [     ]      (     )    &        ||          `     1     2     3    \
 * ctrl insert super shift bspc esc  ||  enter space   fn    .     0    alt
 */
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP(KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, \
         ...
         KC_LCTL, KC_TAB, KC_LGUI, KC_LSFT, KC_BSPC, KC_ESC, KC_ENT,     \
   ...
   * ctrl  voldn  super shift bspc esc  || enter space L0  prtsc scroll alt
   */
  KEYMAP(KC_INS, KC_HOME, KC_UP, KC_END, KC_PGUP, \
                         ...
                         KC_LCTL, KC__VOLDOWN, KC_LGUI, KC_LSFT, KC_BSPC, KC_ESC, \
